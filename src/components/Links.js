...
const PodcastsLink = <Link to="/podcasts"> podcast </Link>
const BooksLink = <Link to="/books"> books</Link>
const SeedFiLink = <a href="https://seedfi.com">SeedFi</a>


export {LandingLink, BooksLink, PodcastsLink,  MusicLink, CuisineLink, ThinkDeeplyLink, SeedFiLink, PhotographyLink, QuestionsLink};